...
- **Multi-Language**: Interface available in English, German, French, Italian, and Simplified Chinese with automatic browser-language detection
...
qui is available in English, German, French, Italian, and Simplified Chinese. The interface detects your browser language on first load and remembers your choice after that.
