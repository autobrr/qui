...
var expectedSchema = map[string][]columnSpec{
	...
	"instances": {
		...
		{Name: "ssh_auth_type", Type: "TEXT"},
		{Name: "ssh_key_encrypted", Type: "TEXT"},
		{Name: "ssh_key_passphrase_encrypted", Type: "TEXT"},
		{Name: "ssh_password_encrypted", Type: "TEXT"},
		{Name: "ssh_host_key", Type: "TEXT"},
		{Name: "helper_path", Type: "TEXT"},
		{Name: "helper_version", Type: "TEXT"},
		{Name: "helper_capabilities", Type: "TEXT"},
		{Name: "helper_allowed_roots", Type: "TEXT"},
		{Name: "helper_reflink_roots", Type: "TEXT"},
		{Name: "helper_platform", Type: "TEXT"},
		{Name: "helper_deployed_at", Type: "DATETIME"},
		{Name: "helper_last_activity_at", Type: "DATETIME"},
	},
	"licenses": {
		{Name: "id", Type: "INTEGER", PrimaryKey: true},
