ALTER TABLE cross_seed_settings
    ADD COLUMN pooled_partial_completion_enabled BOOLEAN NOT NULL DEFAULT FALSE;
...
CREATE TABLE cross_seed_partial_pool_members (
    ...
    started_by_pool BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE cross_seed_partial_pool_member_files (
    ...
    pieces_root TEXT,
    wanted_at_admission BOOLEAN NOT NULL,
    materialized_at_add BOOLEAN NOT NULL,
    status TEXT NOT NULL CHECK (status IN (
