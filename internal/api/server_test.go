...
var undocumentedRoutes = map[routeKey]struct{}{
	...
	{Method: http.MethodPost, Path: "/api/instances/{instanceId}/tracker-rules/preview"}:        {},
	{Method: http.MethodPut, Path: "/api/instances/{instanceId}/tracker-rules/order"}:           {},
	{Method: http.MethodGet, Path: "/api/instances/{instanceId}/tracker-rules/activity"}:        {},
	{Method: http.MethodDelete, Path: "/api/instances/{instanceId}/tracker-rules/activity"}:     {},
