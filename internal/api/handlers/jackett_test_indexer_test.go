...
// TestTestIndexerReportsSearchOutcome pins #2388: SearchGeneric returns as soon
// as the search is scheduled, so an indexer failure only shows up on the
// completion callback, and the endpoint must wait for it.
