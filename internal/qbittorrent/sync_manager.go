...
// and hash sets. Each pass is bounded by trackerHealthRefreshTimeout; a
// provisional MainData-backed mapping may remain in place if full hydration does
// not finish before the pass ends.
