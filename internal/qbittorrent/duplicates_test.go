...
func TestClientLookupDuplicateMatches(t *testing.T) {
	...
	torrents := map[string]qbt.Torrent{
		"ABCDEF1234567890ABCDEF1234567890ABCDEF12": {
			Hash:       "ABCDEF1234567890ABCDEF1234567890ABCDEF12",
			InfohashV1: "1234567890abcdef1234567890abcdef12345678",
			Name:       "Alpha",
		},
	...
	require.True(t, indexed, "expected hash index to be available after rebuild")
	require.Len(t, matches, 1, "expected only one matching torrent")
	assert.Equal(t, "Alpha", matches[0].Name)
	assert.ElementsMatch(t, []string{
		"abcdef1234567890abcdef1234567890abcdef12",
		"1234567890ABCDEF1234567890ABCDEF12345678",
	}, matches[0].MatchedHashes)
