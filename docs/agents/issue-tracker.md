...
- **Promote to issue**: `gh issue create --title "..." --label ready-for-agent --body "..."` with `From discussion #<number>` as the last line of the body. Then comment the issue URL on the discussion.
