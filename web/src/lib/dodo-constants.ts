...
// Production checkout URL (hardcoded).
...
export const DODO_CHECKOUT_URL =
  import.meta.env.DEV && import.meta.env.VITE_DODO_TEST_CHECKOUT_URL? import.meta.env.VITE_DODO_TEST_CHECKOUT_URL: "https://dodo.pe/qui"
