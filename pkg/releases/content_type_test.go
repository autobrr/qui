...
func TestDetermineContentType(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "education is unknown despite a year", release: &rls.Release{Type: rls.Education, Year: 2021}, want: ContentTypeUnknown},
		{name: "magazine counts as book", release: &rls.Release{Type: rls.Magazine, Year: 2021}, want: ContentTypeBook},
